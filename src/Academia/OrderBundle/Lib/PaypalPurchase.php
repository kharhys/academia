...
use Academia\OrderBundle\Lib\PaypalCommodity;
 ...
 */
class PaypalPurchase extends PayPalCommodity {
     ...
     *
     * This function returns the response from PayPal, which includes a profile ID (PROFILEID). You should
     ...
     * @internal param $profile_id , string. The profile ID of the subscription for which the details should be looked up.
     * @return array (
